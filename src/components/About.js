          ...
          <div className="row ">
            ...
            <div className="col-lg-4 order-2 order-lg-1">
              <p>
                ...
                resourceful and innovative, while my positive can-do attitude
            ...
            <div className="col-lg-4 order-3 order-lg-3">
              <p>
                I became interested in developing apps after watching my
                children play games on their iPads. I taught myself Python and C
                and before I knew it, I caught the coding bug! I recently
                completed General Assembly's Software Engineering Immersive
                Program where I spent 80-hours a week for 13-weeks expanding my
                technical toolkit with a focus on MERN stack (MongoDB, Express,
                React.js, Node.js).
              </p>
